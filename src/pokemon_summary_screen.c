...
/**
 * A function that accepts the nature modification as a parameter and colors the stats accordingly.
 *
 * This function checks the nature modification and adds the corresponding colors. The list of colors can be found in
 * charmap.txt and the constants can be modified as you wish. Then, ConvertIntToDecimalStringN is called to convert the
 * stat into text. This function also leaves the color modifier from before intact. Finally, a placeholder is set using
